...
5. 논문·연구 figure이면 `guides/technical-figure-code.md`와 `guides/scientific-figure-generation.md`를 모두 읽되, 현재 사용자가 요청한 medium과 산출물 수를 따른다. Code/generated 결과를 자동으로 함께 만들거나 generated-raster-only 요청을 conflict로 처리하지 않는다.
